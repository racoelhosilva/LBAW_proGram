...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <!-- Styles & Scripts -->
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/header.js', 'resources/js/search.js', 'resources/js/user.js', 'resources/js/post.js', 'resources/js/comment.js', 'resources/js/faq.js'])
    </head>
