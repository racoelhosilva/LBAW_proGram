        ...
        <section class="flex flex-col items-center mt-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 m-8">
                <div class="flex flex-col items-center gap-4">
                    <img alt="Bruno's Photo" src="{{ asset('devs/bruno.jpg') }}" class="rounded-full border-2 border-gray-300 w-32 h-32 object-cover">
                ...
                <div class="flex flex-col items-center gap-4">
                    <img alt="Henrique's Photo" src="{{ asset('devs/henrique.jpg') }}" class="rounded-full border-2 border-gray-300 w-32 h-32 object-cover">
                ...
                <div class="flex flex-col items-center gap-4">
                    <img alt="José's Photo" src="{{ asset('devs/jose.jpg') }}" class="rounded-full border-2 border-gray-300 w-32 h-32 object-cover">
                ...
                <div class="flex flex-col items-center gap-4">
                    <img alt="Rodrigo's Photo" src="{{ asset('devs/rodrigo.jpg') }}" class="rounded-full border-2 border-gray-300 w-32 h-32 object-cover">
