...
@php
    $resources = [
        'Posts' => [
            ...
            ['method' => 'GET', 'endpoint' => '/api/post/{id}', 'access' => 'Public', 'description' => 'Get a specific post by ID'],
            ['method' => 'POST', 'endpoint' => '/api/post', 'access' => 'Private', 'description' => 'Create a new post'],
            ['method' => 'PUT', 'endpoint' => '/api/post/{id}', 'access' => 'Private', 'description' => 'Update a post by ID'],
            ['method' => 'DELETE', 'endpoint' => '/api/post/{id}', 'access' => 'Private', 'description' => 'Delete a post by ID'],
            ['method' => 'GET', 'endpoint' => '/api/post/{id}/like', 'access' => 'Private', 'description' => 'Get likes for a post'],
            ['method' => 'POST', 'endpoint' => '/api/post/{id}/like', 'access' => 'Private', 'description' => 'Like a post'],
        ...
        'Comments' => [
            ...
            ['method' => 'POST', 'endpoint' => '/api/comment', 'access' => 'Private', 'description' => 'Create a new comment'],
            ['method' => 'GET', 'endpoint' => '/api/comment/{id}', 'access' => 'Public', 'description' => 'Get a specific comment by ID'],
            ['method' => 'PUT', 'endpoint' => '/api/comment/{id}', 'access' => 'Private', 'description' => 'Update a comment by ID'],
            ['method' => 'DELETE', 'endpoint' => '/api/comment/{id}', 'access' => 'Private', 'description' => 'Delete a comment by ID'],
            ['method' => 'POST', 'endpoint' => '/api/comment/{id}/like', 'access' => 'Private', 'description' => 'Like a comment'],
            ['method' => 'DELETE', 'endpoint' => '/api/comment/{id}/like', 'access' => 'Private', 'description' => 'Unlike a comment'],
        ],
        'Groups' => [
            ['method' => 'GET', 'endpoint' => '/api/group', 'access' => 'Public', 'description' => 'Get all groups'],
            ['method' => 'POST', 'endpoint' => '/api/group', 'access' => 'Private', 'description' => 'Create a new group'],
            ['method' => 'PUT', 'endpoint' => '/api/group/{id}', 'access' => 'Private', 'description' => 'Update a group by ID'],
            ['method' => 'GET', 'endpoint' => '/api/group/{id}', 'access' => 'Public', 'description' => 'Get a specific group by ID'],
            ['method' => 'POST', 'endpoint' => '/api/group/{id}/join', 'access' => 'Private', 'description' => 'Join a group'],
            ['method' => 'DELETE', 'endpoint' => '/api/group/{id}/leave', 'access' => 'Private', 'description' => 'Leave a group'],
            ['method' => 'DELETE', 'endpoint' => '/api/group/{id}/remove/{user_id}', 'access' => 'Private', 'description' => 'Remove a user from a group'],
        ...
        'Users' => [
            ...
            ['method' => 'GET', 'endpoint' => '/api/user/{id}', 'access' => 'Private', 'description' => 'Get a specific user by ID'],
            ['method' => 'POST', 'endpoint' => '/api/user', 'access' => 'Private', 'description' => 'Create a new user'],
            ['method' => 'DELETE', 'endpoint' => '/api/user/{id}', 'access' => 'Private', 'description' => 'Delete a user'],
            ['method' => 'PUT', 'endpoint' => '/api/user/{id}', 'access' => 'Private', 'description' => 'Update a user by ID'],
            ['method' => 'GET', 'endpoint' => '/api/user/{id}/followers', 'access' => 'Private', 'description' => 'List all followers of a user'],
            ['method' => 'GET', 'endpoint' => '/api/user/{id}/following', 'access' => 'Private', 'description' => 'List all users the user is following'],
            ['method' => 'GET', 'endpoint' => '/api/user/{id}/post', 'access' => 'Private', 'description' => 'List all posts of a user'],
            ['method' => 'POST', 'endpoint' => '/api/user/{id}/notifications/read', 'access' => 'Private', 'description' => 'Mark all notifications as read for a user'],
            ['method' => 'POST', 'endpoint' => '/api/user/{userId}/notification/{notificationId}/read', 'access' => 'Private', 'description' => 'Mark a specific notification as read for a user'],
            ['method' => 'POST', 'endpoint' => '/api/user/{id}/follow', 'access' => 'Private', 'description' => 'Follow a user'],
            ['method' => 'DELETE', 'endpoint' => '/api/user/{id}/follow', 'access' => 'Private', 'description' => 'Unfollow a user'],
