...
@section('content')
    @php
        $faqs = [
            ...
            ['question' => 'How can I create a post', 'answer' => 'You can create a post by clicking the dropdown on the top right of the page and choosing the create post option. You will need to provide a title, content for your post, tags for the post, specify its visibility and even mark it is an announcement.'],
